...
export const financeCopy: Record<FinanceLocale, FinanceCopy> = {
  'en-CA': {
    ...
    transactionsUnavailable: 'Transaction data is currently unavailable.',
    loadMoreRecords: 'Load more finance records',
    budgets: 'Budgets',
    allocated: 'allocated',
    noBudgets: 'No budgets have been saved yet.',
    budgetsLoading: 'Budget data is loading…',
    budgetsUnavailable: 'Budget data is currently unavailable.',
  ...
  'fr-CA': {
    ...
    title: 'Finances',
    description:
      'Livres comptables, documents, factures et planification de votre espace de travail.',
    ...
    transactionsUnavailable:
      'Les données d’opérations sont actuellement indisponibles.',
    ...
    budgetsUnavailable:
      'Les données de budget sont actuellement indisponibles.',
  ...
  'ja-JP': {
    ...
    title: 'ファイナンス',
    description:
      'ワークスペースの帳簿、書類、請求書、仕入請求書、資金計画を管理します。',
  ...
  'ko-KR': {
    ...
    title: '금융',
    description:
      '워크스페이스의 장부, 문서, 매출·매입 청구서 및 재무 계획을 관리합니다.',
    ...
    transactionsUnavailable: '현재 거래 데이터를 사용할 수 없습니다.',
    loadMoreRecords: '금융 기록 더 불러오기',
    budgets: '예산',
    allocated: '배정됨',
    noBudgets: '아직 저장된 예산이 없습니다.',
    budgetsLoading: '예산 데이터를 불러오는 중…',
    budgetsUnavailable: '현재 예산 데이터를 사용할 수 없습니다.',
