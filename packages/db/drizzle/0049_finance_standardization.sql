CREATE TABLE "emdo"."finance_standardization_configuration" (
	"id" text PRIMARY KEY NOT NULL,
	"ready" boolean DEFAULT false NOT NULL,
	"max_run_cad_minor" integer DEFAULT 0 NOT NULL,
	"max_workspace_day_cad_minor" integer DEFAULT 0 NOT NULL,
	CONSTRAINT "standardization_configuration_bounds" CHECK ("emdo"."finance_standardization_configuration"."id"='v1' and "emdo"."finance_standardization_configuration"."max_run_cad_minor">=0 and "emdo"."finance_standardization_configuration"."max_workspace_day_cad_minor">=0 and (not "emdo"."finance_standardization_configuration"."ready" or ("emdo"."finance_standardization_configuration"."max_run_cad_minor">0 and "emdo"."finance_standardization_configuration"."max_workspace_day_cad_minor">0)))
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_standardization_extractions" (
	...
	CONSTRAINT "standardization_extraction_revision" UNIQUE("run_id","revision"),
	CONSTRAINT "standardization_extraction_bounds" CHECK ("emdo"."finance_standardization_extractions"."revision">0 and octet_length("emdo"."finance_standardization_extractions"."envelope"::text)<=1048576 and "emdo"."finance_standardization_extractions"."source_digest" ~ '^[a-f0-9]{64}$' and "emdo"."finance_standardization_extractions"."extraction_digest" ~ '^[a-f0-9]{64}$')
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_standardization_runs" (
	"id" uuid PRIMARY KEY NOT NULL,
	...
	"delivery_pending" boolean DEFAULT true NOT NULL,
	"lease_token" uuid,
	"lease_expires_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "standardization_source_author" UNIQUE("workspace_id","book_id","evidence_id","source_digest","authorized_by"),
	CONSTRAINT "standardization_run_scope" UNIQUE("workspace_id","book_id","id"),
	CONSTRAINT "standardization_run_bounds" CHECK ("emdo"."finance_standardization_runs"."revision">0 and "emdo"."finance_standardization_runs"."authority_epoch">0 and "emdo"."finance_standardization_runs"."attempt" between 0 and 3 and "emdo"."finance_standardization_runs"."delivery_revision">0 and "emdo"."finance_standardization_runs"."source_digest" ~ '^[a-f0-9]{64}$' and "emdo"."finance_standardization_runs"."status" in ('queued','extracting','proposing','needs-review','blocked','authority-revoked','cancelled','indeterminate') and jsonb_typeof("emdo"."finance_standardization_runs"."blockers")='array' and octet_length("emdo"."finance_standardization_runs"."blockers"::text)<=65536 and coalesce(octet_length("emdo"."finance_standardization_runs"."extraction"::text),0)<=131072 and coalesce(octet_length("emdo"."finance_standardization_runs"."proposal"::text),0)<=131072 and coalesce(octet_length("emdo"."finance_standardization_runs"."model_provenance"::text),0)<=8192)
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_standardization_spend" (
	"id" uuid PRIMARY KEY NOT NULL,
	"run_id" uuid NOT NULL,
	...
	"reserved_cad_minor" integer NOT NULL,
	"actual_cad_minor" integer,
	"status" text DEFAULT 'reserved' NOT NULL,
	"provider_response_id" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"settled_at" timestamp with time zone,
	CONSTRAINT "standardization_spend_attempt" UNIQUE("run_id","attempt"),
	CONSTRAINT "standardization_spend_bounds" CHECK ("emdo"."finance_standardization_spend"."attempt" between 1 and 3 and "emdo"."finance_standardization_spend"."input_token_ceiling" between 1 and 20000 and "emdo"."finance_standardization_spend"."output_token_ceiling" between 1 and 4000 and "emdo"."finance_standardization_spend"."reserved_cad_minor">0 and ("emdo"."finance_standardization_spend"."actual_cad_minor" is null or "emdo"."finance_standardization_spend"."actual_cad_minor">=0) and "emdo"."finance_standardization_spend"."status" in ('reserved','completed','not-sent','indeterminate') and length("emdo"."finance_standardization_spend"."request_key") between 1 and 200 and length("emdo"."finance_standardization_spend"."pricing_version") between 1 and 128)
);
--> statement-breakpoint
ALTER TABLE "emdo"."finance_standardization_extractions" ADD CONSTRAINT "finance_standardization_extractions_run_id_finance_standardization_runs_id_fk" FOREIGN KEY ("run_id") REFERENCES "emdo"."finance_standardization_runs"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_standardization_runs" ADD CONSTRAINT "finance_standardization_runs_authorized_by_auth_users_id_fk" FOREIGN KEY ("authorized_by") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_standardization_runs" ADD CONSTRAINT "finance_standardization_runs_reviewed_mapping_id_finance_report_mapping_versions_id_fk" FOREIGN KEY ("reviewed_mapping_id") REFERENCES "emdo"."finance_report_mapping_versions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_standardization_runs" ADD CONSTRAINT "standardization_evidence_scope" FOREIGN KEY ("workspace_id","book_id","evidence_id") REFERENCES "emdo"."finance_book_evidence"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_standardization_spend" ADD CONSTRAINT "finance_standardization_spend_run_id_finance_standardization_runs_id_fk" FOREIGN KEY ("run_id") REFERENCES "emdo"."finance_standardization_runs"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "standardization_delivery_due" ON "emdo"."finance_standardization_runs" USING btree ("delivery_expires_at") WHERE "emdo"."finance_standardization_runs"."delivery_pending" and "emdo"."finance_standardization_runs"."status"='queued';--> statement-breakpoint
--> statement-breakpoint
