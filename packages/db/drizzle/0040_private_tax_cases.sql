CREATE TABLE "emdo"."finance_tax_book_sources" (
	...
	"book_grant_revision" integer NOT NULL,
	"snapshot_revision" integer DEFAULT 1 NOT NULL,
	"snapshot_hash" text NOT NULL,
	"snapshot" jsonb NOT NULL,
	"revoked_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "tax_book_source_once" UNIQUE("workspace_id","case_id","book_id"),
	CONSTRAINT "tax_book_source_version" CHECK ("emdo"."finance_tax_book_sources"."authorization_revision">0 and "emdo"."finance_tax_book_sources"."book_grant_revision">0 and "emdo"."finance_tax_book_sources"."snapshot_revision">0 and "emdo"."finance_tax_book_sources"."snapshot_hash" ~ '^[0-9a-f]{64}$' and octet_length("emdo"."finance_tax_book_sources"."snapshot"::text)<=8000000)
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_tax_case_grants" (
	"workspace_id" uuid NOT NULL,
	"case_id" uuid NOT NULL,
	"tax_subject_id" uuid NOT NULL,
	...
	"revoked_at" timestamp with time zone,
	CONSTRAINT "finance_tax_case_grants_workspace_id_case_id_user_id_pk" PRIMARY KEY("workspace_id","case_id","user_id"),
	CONSTRAINT "tax_case_grant_role" CHECK ("emdo"."finance_tax_case_grants"."role" in ('owner','preparer','reviewer','viewer') and "emdo"."finance_tax_case_grants"."revision">0)
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_tax_case_snapshots" (
	"workspace_id" uuid NOT NULL,
	"case_id" uuid NOT NULL,
	"tax_subject_id" uuid NOT NULL,
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "finance_tax_case_snapshots_workspace_id_case_id_revision_pk" PRIMARY KEY("workspace_id","case_id","revision"),
	CONSTRAINT "tax_snapshot_bounds" CHECK ("emdo"."finance_tax_case_snapshots"."revision">0 and "emdo"."finance_tax_case_snapshots"."snapshot_hash" ~ '^[0-9a-f]{64}$' and ("emdo"."finance_tax_case_snapshots"."previous_snapshot_hash" is null or "emdo"."finance_tax_case_snapshots"."previous_snapshot_hash" ~ '^[0-9a-f]{64}$') and jsonb_typeof("emdo"."finance_tax_case_snapshots"."questionnaire")='object' and octet_length("emdo"."finance_tax_case_snapshots"."questionnaire"::text)<=8000000)
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_tax_cases" (
	"id" uuid PRIMARY KEY NOT NULL,
	"workspace_id" uuid NOT NULL,
	"tax_subject_id" uuid NOT NULL,
	"title" text NOT NULL,
	...
	"created_by" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "tax_case_identity" UNIQUE("workspace_id","id","tax_subject_id"),
	CONSTRAINT "tax_case_no_complete" CHECK ("emdo"."finance_tax_cases"."status"='incomplete' and "emdo"."finance_tax_cases"."current_revision">=0)
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_tax_fact_sources" (
	"id" uuid NOT NULL,
	"workspace_id" uuid NOT NULL,
	"case_id" uuid NOT NULL,
	"tax_subject_id" uuid NOT NULL,
	...
	"created_by" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "finance_tax_fact_sources_workspace_id_case_id_id_revision_pk" PRIMARY KEY("workspace_id","case_id","id","revision"),
	CONSTRAINT "tax_fact_source_bounds" CHECK ("emdo"."finance_tax_fact_sources"."revision">0 and "emdo"."finance_tax_fact_sources"."content_hash" ~ '^[0-9a-f]{64}$' and jsonb_typeof("emdo"."finance_tax_fact_sources"."value")='object' and octet_length("emdo"."finance_tax_fact_sources"."value"::text)<=10000)
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_tax_receipts" (
	"workspace_id" uuid NOT NULL,
	"user_id" uuid NOT NULL,
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "finance_tax_receipts_workspace_id_user_id_idempotency_key_pk" PRIMARY KEY("workspace_id","user_id","idempotency_key"),
	CONSTRAINT "tax_receipt_hash" CHECK ("emdo"."finance_tax_receipts"."command_hash" ~ '^[0-9a-f]{64}$')
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_tax_subjects" (
	"id" uuid PRIMARY KEY NOT NULL,
	"workspace_id" uuid NOT NULL,
	...
	"created_by" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "tax_subject_scope" UNIQUE("workspace_id","id"),
	CONSTRAINT "tax_subject_type" CHECK ("emdo"."finance_tax_subjects"."taxpayer_type" in ('individual','sole-proprietor','corporation'))
);
--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_book_sources" ADD CONSTRAINT "finance_tax_book_sources_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_book_sources" ADD CONSTRAINT "finance_tax_book_sources_authorized_by_auth_users_id_fk" FOREIGN KEY ("authorized_by") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_book_sources" ADD CONSTRAINT "finance_tax_book_sources_workspace_id_case_id_tax_subject_id_finance_tax_cases_workspace_id_id_tax_subject_id_fk" FOREIGN KEY ("workspace_id","case_id","tax_subject_id") REFERENCES "emdo"."finance_tax_cases"("workspace_id","id","tax_subject_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_book_sources" ADD CONSTRAINT "finance_tax_book_sources_workspace_id_book_id_finance_books_workspace_id_id_fk" FOREIGN KEY ("workspace_id","book_id") REFERENCES "emdo"."finance_books"("workspace_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_case_grants" ADD CONSTRAINT "finance_tax_case_grants_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_case_grants" ADD CONSTRAINT "finance_tax_case_grants_user_id_auth_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_case_grants" ADD CONSTRAINT "finance_tax_case_grants_workspace_id_case_id_tax_subject_id_finance_tax_cases_workspace_id_id_tax_subject_id_fk" FOREIGN KEY ("workspace_id","case_id","tax_subject_id") REFERENCES "emdo"."finance_tax_cases"("workspace_id","id","tax_subject_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_case_snapshots" ADD CONSTRAINT "finance_tax_case_snapshots_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_case_snapshots" ADD CONSTRAINT "finance_tax_case_snapshots_created_by_auth_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_case_snapshots" ADD CONSTRAINT "finance_tax_case_snapshots_workspace_id_case_id_tax_subject_id_finance_tax_cases_workspace_id_id_tax_subject_id_fk" FOREIGN KEY ("workspace_id","case_id","tax_subject_id") REFERENCES "emdo"."finance_tax_cases"("workspace_id","id","tax_subject_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_cases" ADD CONSTRAINT "finance_tax_cases_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_cases" ADD CONSTRAINT "finance_tax_cases_created_by_auth_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_cases" ADD CONSTRAINT "tax_case_subject" FOREIGN KEY ("workspace_id","tax_subject_id") REFERENCES "emdo"."finance_tax_subjects"("workspace_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_fact_sources" ADD CONSTRAINT "finance_tax_fact_sources_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_fact_sources" ADD CONSTRAINT "finance_tax_fact_sources_created_by_auth_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_fact_sources" ADD CONSTRAINT "finance_tax_fact_sources_workspace_id_case_id_tax_subject_id_finance_tax_cases_workspace_id_id_tax_subject_id_fk" FOREIGN KEY ("workspace_id","case_id","tax_subject_id") REFERENCES "emdo"."finance_tax_cases"("workspace_id","id","tax_subject_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_receipts" ADD CONSTRAINT "finance_tax_receipts_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_receipts" ADD CONSTRAINT "finance_tax_receipts_user_id_auth_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_subjects" ADD CONSTRAINT "finance_tax_subjects_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_subjects" ADD CONSTRAINT "finance_tax_subjects_created_by_auth_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;
--> statement-breakpoint
