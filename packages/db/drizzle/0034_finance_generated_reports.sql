CREATE TABLE "emdo"."finance_generated_reports" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"workspace_id" uuid NOT NULL,
	"book_id" uuid NOT NULL,
	"automation_run_id" uuid NOT NULL,
	"report_version" integer DEFAULT 1 NOT NULL,
	"kind" text DEFAULT 'posted-ledger-trial-balance' NOT NULL,
	"coverage" text DEFAULT 'all-posted-journals-at-snapshot' NOT NULL,
	"currency" text NOT NULL,
	"snapshot_at" timestamp with time zone NOT NULL,
	"snapshot" jsonb NOT NULL,
	CONSTRAINT "generated_report_run" UNIQUE("automation_run_id"),
	CONSTRAINT "generated_report_scope" UNIQUE("workspace_id","book_id","id"),
	CONSTRAINT "generated_report_version" CHECK ("emdo"."finance_generated_reports"."report_version"=1 and "emdo"."finance_generated_reports"."kind"='posted-ledger-trial-balance' and "emdo"."finance_generated_reports"."coverage"='all-posted-journals-at-snapshot'),
	CONSTRAINT "generated_report_currency" CHECK ("emdo"."finance_generated_reports"."currency" in ('CAD','USD','MXN','EUR','KRW','JPY')),
	CONSTRAINT "generated_report_bounded_snapshot" CHECK (jsonb_typeof("emdo"."finance_generated_reports"."snapshot")='object' and octet_length("emdo"."finance_generated_reports"."snapshot"::text)<=8000000)
);
--> statement-breakpoint
ALTER TABLE "emdo"."finance_automation_runs" ADD CONSTRAINT "automation_run_scope" UNIQUE("workspace_id","book_id","id");--> statement-breakpoint
ALTER TABLE "emdo"."finance_generated_reports" ADD CONSTRAINT "generated_report_run_scope" FOREIGN KEY ("workspace_id","book_id","automation_run_id") REFERENCES "emdo"."finance_automation_runs"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
--> statement-breakpoint
...
GRANT EXECUTE ON FUNCTION emdo.generate_finance_trial_balance(uuid,integer,uuid) TO emdo_worker;
