CREATE TABLE "emdo"."finance_tax_calculation_runs" (
	...
	CONSTRAINT "tax_run_identity" UNIQUE("workspace_id","case_id","id"),
	CONSTRAINT "tax_run_incomplete_only" CHECK ("emdo"."finance_tax_calculation_runs"."complete"=false and "emdo"."finance_tax_calculation_runs"."status" in ('blocked-input','incomplete-working-papers') and "emdo"."finance_tax_calculation_runs"."output"->'complete'='false'::jsonb and "emdo"."finance_tax_calculation_runs"."output"->'enabled'='false'::jsonb and "emdo"."finance_tax_calculation_runs"."output"->'reportable'='false'::jsonb),
	CONSTRAINT "tax_run_hashes" CHECK ("emdo"."finance_tax_calculation_runs"."snapshot_hash" ~ '^[a-f0-9]{64}$' and "emdo"."finance_tax_calculation_runs"."package_hash" ~ '^[a-f0-9]{64}$' and "emdo"."finance_tax_calculation_runs"."input_hash" ~ '^[a-f0-9]{64}$' and "emdo"."finance_tax_calculation_runs"."output_hash" ~ '^[a-f0-9]{64}$' and octet_length("emdo"."finance_tax_calculation_runs"."input"::text)<=8000000 and octet_length("emdo"."finance_tax_calculation_runs"."output"::text)<=8000000)
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_tax_run_reviews" (
	"workspace_id" uuid NOT NULL,
	"case_id" uuid NOT NULL,
	...
	"created_by" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "tax_run_review_not_fileable" CHECK ("emdo"."finance_tax_run_reviews"."acknowledgement"='reviewed-incomplete-working-papers-not-fileable' and "emdo"."finance_tax_run_reviews"."output_hash" ~ '^[a-f0-9]{64}$')
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_tax_run_schedules" (
	"workspace_id" uuid NOT NULL,
	"case_id" uuid NOT NULL,
	"run_id" uuid NOT NULL,
	...
	CONSTRAINT "finance_tax_run_schedules_workspace_id_case_id_run_id_form_id_pk" PRIMARY KEY("workspace_id","case_id","run_id","form_id"),
	CONSTRAINT "tax_schedule_hash" CHECK ("emdo"."finance_tax_run_schedules"."content_hash" ~ '^[a-f0-9]{64}$' and jsonb_typeof("emdo"."finance_tax_run_schedules"."content")='array' and octet_length("emdo"."finance_tax_run_schedules"."content"::text)<=8000000)
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_tax_working_input_reviews" (
	"workspace_id" uuid NOT NULL,
	"case_id" uuid NOT NULL,
	"tax_subject_id" uuid NOT NULL,
	"snapshot_revision" integer NOT NULL,
	...
	"created_by" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "tax_working_input_review_pk" PRIMARY KEY("workspace_id","case_id","snapshot_revision","source_id","source_revision","package_hash"),
	CONSTRAINT "tax_working_input_hashes" CHECK ("emdo"."finance_tax_working_input_reviews"."source_hash" ~ '^[a-f0-9]{64}$' and "emdo"."finance_tax_working_input_reviews"."snapshot_hash" ~ '^[a-f0-9]{64}$' and "emdo"."finance_tax_working_input_reviews"."package_hash" ~ '^[a-f0-9]{64}$')
);
--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_calculation_runs" ADD CONSTRAINT "finance_tax_calculation_runs_created_by_auth_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_calculation_runs" ADD CONSTRAINT "finance_tax_calculation_runs_workspace_id_case_id_snapshot_revision_finance_tax_case_snapshots_workspace_id_case_id_revision_fk" FOREIGN KEY ("workspace_id","case_id","snapshot_revision") REFERENCES "emdo"."finance_tax_case_snapshots"("workspace_id","case_id","revision") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_run_reviews" ADD CONSTRAINT "finance_tax_run_reviews_created_by_auth_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_run_reviews" ADD CONSTRAINT "finance_tax_run_reviews_workspace_id_case_id_run_id_finance_tax_calculation_runs_workspace_id_case_id_id_fk" FOREIGN KEY ("workspace_id","case_id","run_id") REFERENCES "emdo"."finance_tax_calculation_runs"("workspace_id","case_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_run_schedules" ADD CONSTRAINT "finance_tax_run_schedules_workspace_id_case_id_run_id_finance_tax_calculation_runs_workspace_id_case_id_id_fk" FOREIGN KEY ("workspace_id","case_id","run_id") REFERENCES "emdo"."finance_tax_calculation_runs"("workspace_id","case_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_working_input_reviews" ADD CONSTRAINT "finance_tax_working_input_reviews_created_by_auth_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "emdo"."auth_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_working_input_reviews" ADD CONSTRAINT "tax_working_review_snapshot_fk" FOREIGN KEY ("workspace_id","case_id","snapshot_revision") REFERENCES "emdo"."finance_tax_case_snapshots"("workspace_id","case_id","revision") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_working_input_reviews" ADD CONSTRAINT "tax_working_review_source_fk" FOREIGN KEY ("workspace_id","case_id","source_id","source_revision") REFERENCES "emdo"."finance_tax_fact_sources"("workspace_id","case_id","id","revision") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
