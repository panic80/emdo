CREATE TABLE "emdo"."finance_commercial_documents" (
	...
	"total" numeric(38, 12) DEFAULT '0' NOT NULL,
	CONSTRAINT "finance_commercial_documents_scope" UNIQUE("workspace_id","book_id","id"),
	CONSTRAINT "finance_commercial_documents_reference" UNIQUE("workspace_id","book_id","kind","party_id","reference"),
	CONSTRAINT "finance_commercial_documents_journal" UNIQUE("workspace_id","book_id","journal_id"),
	CONSTRAINT "finance_commercial_documents_kind" CHECK ("emdo"."finance_commercial_documents"."kind" in ('sales-invoice','supplier-bill')),
	CONSTRAINT "finance_commercial_documents_status" CHECK ("emdo"."finance_commercial_documents"."status" in ('draft','issued','void')),
	CONSTRAINT "finance_commercial_documents_dates" CHECK ("emdo"."finance_commercial_documents"."due_on" >= "emdo"."finance_commercial_documents"."issued_on"),
	CONSTRAINT "finance_commercial_documents_total" CHECK ("emdo"."finance_commercial_documents"."total" >= 0 and "emdo"."finance_commercial_documents"."total" <> 'NaN'::numeric)
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_commercial_lines" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"workspace_id" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"book_id" uuid NOT NULL,
	...
	"tax_amount" numeric(38, 12) DEFAULT '0' NOT NULL,
	"tax_account_id" uuid,
	CONSTRAINT "finance_commercial_lines_number" UNIQUE("workspace_id","book_id","document_id","line_number"),
	CONSTRAINT "finance_commercial_lines_amounts" CHECK ("emdo"."finance_commercial_lines"."line_number">0 and "emdo"."finance_commercial_lines"."net_amount">0 and "emdo"."finance_commercial_lines"."tax_amount">=0 and "emdo"."finance_commercial_lines"."net_amount"<>'NaN'::numeric and "emdo"."finance_commercial_lines"."tax_amount"<>'NaN'::numeric and (("emdo"."finance_commercial_lines"."tax_amount"=0 and "emdo"."finance_commercial_lines"."tax_account_id" is null) or ("emdo"."finance_commercial_lines"."tax_amount">0 and "emdo"."finance_commercial_lines"."tax_account_id" is not null)))
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_parties" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"workspace_id" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"book_id" uuid NOT NULL,
	...
	"kind" text NOT NULL,
	"reference" text NOT NULL,
	CONSTRAINT "finance_parties_scope" UNIQUE("workspace_id","book_id","id"),
	CONSTRAINT "finance_parties_reference" UNIQUE("workspace_id","book_id","reference"),
	CONSTRAINT "finance_parties_kind" CHECK ("emdo"."finance_parties"."kind" in ('person','organization'))
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_payment_allocations" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"workspace_id" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"book_id" uuid NOT NULL,
	...
	CONSTRAINT "finance_payment_allocations_document" UNIQUE("workspace_id","book_id","payment_id","document_id"),
	CONSTRAINT "finance_payment_allocations_amount" CHECK ("emdo"."finance_payment_allocations"."amount">0 and "emdo"."finance_payment_allocations"."amount"<>'NaN'::numeric)
);
--> statement-breakpoint
CREATE TABLE "emdo"."finance_payments" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"workspace_id" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"book_id" uuid NOT NULL,
	...
	"void_journal_id" uuid,
	"total" numeric(38, 12) DEFAULT '0' NOT NULL,
	CONSTRAINT "finance_payments_scope" UNIQUE("workspace_id","book_id","id"),
	CONSTRAINT "finance_payments_reference" UNIQUE("workspace_id","book_id","direction","reference"),
	CONSTRAINT "finance_payments_journal" UNIQUE("workspace_id","book_id","journal_id"),
	CONSTRAINT "finance_payments_direction" CHECK ("emdo"."finance_payments"."direction" in ('receipt','disbursement')),
	CONSTRAINT "finance_payments_status" CHECK ("emdo"."finance_payments"."status" in ('draft','posted','void')),
	CONSTRAINT "finance_payments_total" CHECK ("emdo"."finance_payments"."total">=0 and "emdo"."finance_payments"."total"<>'NaN'::numeric)
);
--> statement-breakpoint
ALTER TABLE "emdo"."finance_commercial_documents" ADD CONSTRAINT "finance_commercial_documents_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_commercial_documents" ADD CONSTRAINT "finance_commercial_documents_book" FOREIGN KEY ("workspace_id","book_id") REFERENCES "emdo"."finance_books"("workspace_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_commercial_documents" ADD CONSTRAINT "finance_commercial_documents_party" FOREIGN KEY ("workspace_id","book_id","party_id") REFERENCES "emdo"."finance_parties"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_commercial_documents" ADD CONSTRAINT "finance_commercial_documents_control" FOREIGN KEY ("workspace_id","book_id","control_account_id") REFERENCES "emdo"."finance_ledger_accounts"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_commercial_documents" ADD CONSTRAINT "finance_commercial_documents_journal_fk" FOREIGN KEY ("workspace_id","book_id","journal_id") REFERENCES "emdo"."finance_journals"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_commercial_documents" ADD CONSTRAINT "finance_commercial_documents_void_fk" FOREIGN KEY ("workspace_id","book_id","void_journal_id") REFERENCES "emdo"."finance_journals"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_commercial_lines" ADD CONSTRAINT "finance_commercial_lines_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_commercial_lines" ADD CONSTRAINT "finance_commercial_lines_document" FOREIGN KEY ("workspace_id","book_id","document_id") REFERENCES "emdo"."finance_commercial_documents"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_commercial_lines" ADD CONSTRAINT "finance_commercial_lines_account" FOREIGN KEY ("workspace_id","book_id","account_id") REFERENCES "emdo"."finance_ledger_accounts"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_commercial_lines" ADD CONSTRAINT "finance_commercial_lines_tax" FOREIGN KEY ("workspace_id","book_id","tax_account_id") REFERENCES "emdo"."finance_ledger_accounts"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_parties" ADD CONSTRAINT "finance_parties_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_parties" ADD CONSTRAINT "finance_parties_book" FOREIGN KEY ("workspace_id","book_id") REFERENCES "emdo"."finance_books"("workspace_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_payment_allocations" ADD CONSTRAINT "finance_payment_allocations_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_payment_allocations" ADD CONSTRAINT "finance_payment_allocations_payment" FOREIGN KEY ("workspace_id","book_id","payment_id") REFERENCES "emdo"."finance_payments"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_payment_allocations" ADD CONSTRAINT "finance_payment_allocations_document_fk" FOREIGN KEY ("workspace_id","book_id","document_id") REFERENCES "emdo"."finance_commercial_documents"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_payments" ADD CONSTRAINT "finance_payments_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "emdo"."workspaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_payments" ADD CONSTRAINT "finance_payments_book" FOREIGN KEY ("workspace_id","book_id") REFERENCES "emdo"."finance_books"("workspace_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_payments" ADD CONSTRAINT "finance_payments_party" FOREIGN KEY ("workspace_id","book_id","party_id") REFERENCES "emdo"."finance_parties"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_payments" ADD CONSTRAINT "finance_payments_cash" FOREIGN KEY ("workspace_id","book_id","cash_account_id") REFERENCES "emdo"."finance_ledger_accounts"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "emdo"."finance_payments" ADD CONSTRAINT "finance_payments_journal_fk" FOREIGN KEY ("workspace_id","book_id","journal_id") REFERENCES "emdo"."finance_journals"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "finance_payment_allocations_lookup" ON "emdo"."finance_payment_allocations" USING btree ("workspace_id","book_id","document_id");
--> statement-breakpoint
ALTER TABLE "emdo"."finance_payments" ADD CONSTRAINT "finance_payments_void_fk" FOREIGN KEY ("workspace_id","book_id","void_journal_id") REFERENCES "emdo"."finance_journals"("workspace_id","book_id","id") ON DELETE no action ON UPDATE no action;
--> statement-breakpoint
