ALTER TABLE "emdo"."finance_tax_book_sources" DROP CONSTRAINT "tax_book_source_once";--> statement-breakpoint
ALTER TABLE "emdo"."finance_tax_book_sources" ADD CONSTRAINT "tax_book_source_snapshot_version" UNIQUE("workspace_id","case_id","book_id","snapshot_revision");
