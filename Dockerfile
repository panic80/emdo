...
RUN cd /opt/emdo/api \
    && node --input-type=module --eval \
      "await Promise.all([import('./dist/index.js'), import('./dist/cli/migrate.js'), import('./dist/cli/bootstrap-owner.js'), import('./dist/cli/seed-synthetic.js'), import('./dist/cli/staging-acceptance.js')])"
