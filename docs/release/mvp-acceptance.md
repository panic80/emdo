...
| Identity/privacy | live PostgreSQL RLS, Better Auth claim bridge, invite/bootstrap, cross-household probes                     | Local and CI PostgreSQL 17 matrices passed; production auth/provider and staging proof pending                                                                                 |
...
| Operations       | image build, Compose render, fresh migration, pg-boss provision, rollback, encrypted restore drill          | 2026-08-13 CI passed API/worker/web container builds, Compose render, and PostgreSQL migration suites; restore, rollback, and deployment proof pending                         |
